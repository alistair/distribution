...
func (msl *manifestServiceListener) EnumerateReferrer(ctx context.Context, subject digest.Digest, artifactType string, ingester func(v1.Descriptor) error) error {
